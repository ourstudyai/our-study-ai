    ...
    <div style={{
      ...
      <div style={{ position: 'relative', width: '56px', height: '56px' }}>
        <div style={{
          ...
          animation: 'lux-spin 1.2s linear infinite', opacity: 0.6,
        }} />
        <div style={{
          position: 'absolute', inset: '10px', borderRadius: '50%',
          border: '1px solid transparent',
          borderBottomColor: 'var(--gold)', borderLeftColor: 'var(--gold)',
          animation: 'lux-spin 0.8s linear infinite reverse', opacity: 0.4,
        }} />
        <div style={{
          ...
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            <rect x="1" y="8" width="16" height="2" rx="1" fill="var(--gold)" opacity="0.9"/>
          </svg>
        </div>
      </div>
      ...
      <div style={{ textAlign: 'center' }}>
        <p style={{
          ...
          opacity: 0.5,
          margin: 0,
          animation: 'lux-breathe 2s ease-in-out infinite',
        }}>
          Lux Studiorum
        </p>
        {label && (
      ...
      <style>{`
        ...
        @keyframes lux-logo-glow {
          ...
          50%      { filter: drop-shadow(0 0 16px var(--gold-dim)); opacity: 1; }
        }
      `}</style>
    </div>
  );
